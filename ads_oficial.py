...
def renomear_arquivo(pasta_download,novo_nome,padrao_busca):
    data_atual = datetime.now().strftime("%Y%m") 
    novo_nome = f"{novo_nome}_{data_atual}.csv"
    caminho_novo = os.path.join(pasta_download, novo_nome)

    arquivos = glob.glob(os.path.join(pasta_download, padrao_busca))
...
nome_arquivo = renomear_arquivo(pasta_download, novo_nome = "base_google_ads",
padrao_busca="Campaign report*.csv")
...
clicar_em_imagem("img/substituir.png", timeout=3, acao="detectar")
py.press("enter")
clicar_em_imagem("img/aprovado.png", acao="detectar")
...
clicar_em_imagem ("img/mat.png")
clicar_em_imagem ("img/brasil.png")
clicar_em_imagem ("img/cities.png")
...
py.hotkey("ctrl","t")
clicar_em_imagem("img/share.png")
clicar_em_imagem("img/locais.png")
clicar_em_imagem("img/carregar.png")
clicar_em_imagem("img/arquivo.png")

pasta_download = os.path.expanduser("~/Downloads")
nome_arquivo = renomear_arquivo(pasta_download, novo_nome = "base_google_Matched",
padrao_busca="Matched locations report*.csv")
caminho_completo = os.path.join(nome_arquivo)
# Digita o caminho e confirma
time.sleep(1)
py.write(caminho_completo)
...
clicar_em_imagem("img/arquivo.png")
pasta_download = os.path.expanduser("~/Downloads")
nome_arquivo = renomear_arquivo(pasta_download, novo_nome = "base_google_Search",
padrao_busca="Search terms report*.csv")
caminho_completo = os.path.join(nome_arquivo)
# Digita o caminho e confirma
time.sleep(1)
py.write(caminho_completo)
